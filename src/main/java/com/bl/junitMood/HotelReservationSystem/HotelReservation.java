...
public class HotelReservation {
	...
	public String findBestCheapestHotelInMap() {
		int minCost = hotelNameToCostMap.entrySet().stream().min(Map.Entry.comparingByValue()).get().getValue();
	...
	public String findBestRatedHotel(ArrayList<Hotel> hotels) {
		Hotel hotel = hotels.stream().max(Comparator.comparing(Hotel::getRegularDailyRate)).orElse(null);
		return hotel.getHotelName();
	}
